...
console.log('track data gen',trackDataGen);
    ...
    return (
      ...
      <div style={{ padding: '3%', backgroundColor: '#f0f2f5', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
  ...
  <Card style={{ boxShadow: '0 6px 12px rgba(0, 0, 0, 0.1)', borderRadius: '10px', overflow: 'hidden', backgroundColor: '#fff', width: '90%' }}>
    <Spin spinning={loading} tip="Loading...">
      <Table
        dataSource={user_category === 'Consumer' ? trackData : trackDataGen}
        columns={columns}
