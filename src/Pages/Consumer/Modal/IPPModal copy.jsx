...
const IPPModal = ({
  ...
  const dataSource = [
    {
      key: "2",
      label: "Annual Contracted Energy (million units)",
      value: ipp?.annual_demand_met || 0,
    },
    {
      key: "3",
      label: "Potential RE Replacement (%)",
      value: ipp?.reReplacement || "N/A",
    },
    {
      key: "4",
      label: "Per Unit Cost (INR/kWh)",
      value: ipp?.perUnitCost || "N/A",
    },
    ...
    {
      key: "7",
      label: "State Charges (INR/kWh)",
      value: ipp?.state_charges || "N/A",
    },
    { key: "8", label: "Total Cost (INR/kWh)", value: ipp?.totalCost || "N/A" },
    {
      key: "9",
      label: "COD",
      value: ipp?.cod ? moment(ipp.cod).format("DD-MM-YYYY") : "N/A",
    },
    { key: "10", label: "Connectivity", value: ipp?.connectivity || "N/A" },
    {
      key: "11",
      label: "Total RE Capacity (MW)",
      value: ipp?.totalCapacity || "N/A",
    },
    ...(fromConsumer
      ...
      ? [
          {
            key: "12",
            label: "Consumer ID",
            value: consumerDetails?.username || "N/A",
          },
          {
            key: "13",
            label: "Consumer Credit Rating",
            value:
              consumerDetails?.credit_rating === null
                ? "N/A"
                : consumerDetails?.credit_rating,
          },
          {
            key: "14",
            label: "Banking Available",
            value:
              ipp?.banking_available === 1 ? (
  ...
  const mapToBaseType = (value) => {
    ...
    return (
      Object.keys(baseTypes).find((key) =>
          ...
          <Row justify="center" align="middle" gutter={[16, 16]}>
            <Col span={24}>
              ...
              >
                ...
                <div
                  style={{ borderTop: "1px solid #E6E8F1", margin: "20px 0" }}
                />
