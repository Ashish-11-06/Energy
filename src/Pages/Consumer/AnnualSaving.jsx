...
const AnnualSvg = () => {
  ...
  const handleContinue = () => {
    if (status === "active") {
      navigate("/consumer/energy-consumption-table", {
        state: {
          requirementId,
          reReplacement: annualSavingResponse?.re_replacement,
        },
      });
    } else {
  ...
  const dataForBarChart = [
    {
      ...
      formattedSavings: formatter.format(
        annualSavingResponse?.annual_savings || 0
      ),
    },
    {
      ...
      formattedSavings: formatter.format(
        annualSavingResponse?.average_savings || 0
      ),
    },
  ];
  ...
  const dataForTariffComparison = [
    {
      ...
      Tarrif: annualSavingResponse?.electricity_tariff || 0,
    },
    {
      name: "Potential RE Tariff",
      Tarrif: annualSavingResponse?.potential_re_tariff || 0,
    },
    {
      name: "per unit savings Potential",
      Tarrif: annualSavingResponse?.per_unit_savings_potential || 0,
    },
  ];
  ...
  const dataForSavingsBreakdown = [
    {
      name: "ISTS Charges",
      Breakdown: annualSavingResponse?.ISTS_charges || 0,
    },
    {
      name: "State Charges",
      Breakdown: annualSavingResponse?.state_charges || 0,
    },
  ];
        ...
        <main style={{ minHeight: "90vh", position: "relative" }}>
          ...
          >
            ...
            <Col xs={24} sm={24} md={8} lg={8} style={{ padding: "0 5px" }}>
              ...
              >
                Savings Comparison{" "}
                <span style={{ fontSize: "12px" }}> (INR in Cr)</span>
              </Title>
            ...
            <Col xs={24} sm={24} md={8} lg={8} style={{ padding: "0 5px" }}>
              ...
              >
                Tariff Comparison{" "}
                <span style={{ fontSize: "12px" }}> (INR/kWh)</span>
              </Title>
              <div style={{ width: "100%", height: "180px" }}>
                {" "}
                {/* Same height */}
                      ...
                      <Col xs={24} sm={12}>
                        <Text style={{ fontSize: "16px", color: "#9a8406" }}>
                          ...
                          {annualSavingResponse
                            ? annualSavingResponse.contracted_demand
                            : "0"}
                          <span style={{ fontSize: "12px" }}> MW</span>
                        </Text>
                      </Col>
      ...
      <span style={{ fontSize: "12px" }}> Cr INR</span>
                      ...
                      <Col xs={24} sm={12}>
                        <Text style={{ fontSize: "16px" }}>
                          ...
                          {annualSavingResponse &&
                          annualSavingResponse.average_savings !== 0
                            ? `${annualSavingResponse.average_savings.toLocaleString(
                                "en-IN"
                              )} `
                            : "-"}
                          {annualSavingResponse &&
                    ...
                    >
                      <Col xs={12} sm={8} md={6} lg={4}>
                        <Button
                          ...
                          onClick={() =>
                            generatePDF(
                              createPdfContent(annualSavingResponse),
                              requirementId
                            )
                          }
