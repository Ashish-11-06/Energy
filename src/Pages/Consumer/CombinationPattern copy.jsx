                ...
                expandable={{
                  expandedRowRender: (record) => {
                    const transposedColumns = [
                      {
                        title: 'OA Transmission Charge',
                        dataIndex: 'OA_transmission_charge',
                        key: 'OA_transmission_charge',
                      },
                      {
                        title: 'OA Transmission Loss',
                        dataIndex: 'OA_transmission_loss',
                        key: 'OA_transmission_loss',
                      },
                      {
                      ...
                      {
                        title: 'OA Banking Charge',
                        dataIndex: 'OA_banking_charge',
                        key: 'OA_banking_charge',
                      },
                      {
                        title: 'OA Combined Avg Replacement PLF',
                        dataIndex: 'OA_combined_average_replacement_PLF',
                        key: 'OA_combined_average_replacement_PLF',
                      },
                    ];
                    ...
                    const transposedData = [
                      {
                        key: '1',
                        OA_transmission_charge: record.OA_transmission_charge ?? 'N/A',
                        OA_transmission_loss: record.OA_transmission_loss ?? 'N/A',
                        OA_wheeling_charges: record.OA_wheeling_charges ?? 'N/A',
                        OA_wheeling_losses: record.OA_wheeling_losses ?? 'N/A',
                        OA_banking_charge: record.OA_banking_charge ?? 'N/A',
