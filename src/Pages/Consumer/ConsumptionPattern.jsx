...
const ConsumptionPattern = () => {
  ...
  const [isOptimizing, setIsOptimizing] = useState(false); // State for optimization process
  ...
  const handleOptimizeClick = () => {
    setIsOptimizing(true); // Set optimizing state to true when the "Optimize" button is clicked

    // Simulate loading process on Optimize button click
    ...
    >
      <Row justify="center" align="middle" gutter={[16, 8]} style={{ height: "100%" }}>
        ...
        <Col span={24} style={{ textAlign: "center" }}>
          ...
          >
            <Bar data={chartData} options={chartOptions} style={{ height: "160px", width: "90%" }} />
          </div>
        </Col>

        {/* Slider and Table Section */}
            ...
            <Col span={24}>
              <Row justify="center" style={{ marginBottom: "20px" }}>
                <Col span={12} style={{ textAlign: "center" }}>
                  ...
                  />
                  <Text style={{ color: "#001529", fontSize: "14px" }}>
                    Potential RE Replacement of IPP: {sliderValue}%
                  </Text>
                  <Button
                    type="primary"
                    style={{ marginTop: "5px", marginLeft: "20%" }}
