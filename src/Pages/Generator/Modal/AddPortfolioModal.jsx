...
import { Modal, Form, Input, Button, Radio, Row, Col, message } from 'antd';
...
// import industries from '../Data/Industry'; // Assuming industries data is in the 'Industry.js' file
import useRegisterUser from '../../../hook/useRegisterUser'; // Import the custom hook
...
const RegisterModal = ({ open, onCancel }) => {
  ...
  // Destructure register function from the custom hook
  ...
  const onFinish = (values) => {
    ...
    if (selection === 'consumer') {
      ...
      register(newUser); // Call the register function from the hook
