...
const  GeneratorInput = () => {
  ...
  const requirementId = localStorage.getItem('selectedRequirementId') || 26; // Destructure state to get `requirementId` and `annualSaving`
        ...
        <Table
          ...
          columns={[
            ...
            },
            {
              ...
              render: (_, record) => (
                <Checkbox
                  checked={selectedPortfolios.includes(record.id)}
                  onChange={() => handlePortfolioSelect(record.id)}
                />
              ),
            },
          ]}
