...
export const consumerMenuItems = [
  ...
  { key: '5', icon: <img src={findConsumer} alt="" style={{ width: '20px', height: '20px' }} />, label: <Link to="/consumer/rooftop-offers">Onsite RE Offers</Link> },
  { key: '6', icon: <img src={offerSend} alt="" style={{ width: '20px', height: '20px' }}/> , label: <Link to="/offers">Offers</Link> },
  { key: '7', icon: <img src={offerSend} alt="" style={{ width: '20px', height: '20px' }}/> , label: <Link to="/transaction-page">Transaction Window</Link> },
...
export const generatorMenuItems = [
  ...
  { key: '11', icon: <img src={findConsumer} alt="" style={{ width: '20px', height: '20px' }} />, label: <Link to="/generator/matching-consumer">Find Consumer</Link> },
  { key: '12', icon: <img src={invoice} alt="" style={{ width: '20px', height: '20px' }} />, label: <Link to="/generator/GeneratorInput">Capacity Sizing</Link> },
  { key: '13', icon: <img src={invoice} alt="" style={{ width: '20px', height: '20px' }} />, label: <Link to="/generator/rooftop">Onsite RE Lead Generation</Link> },
  
  { key: '14', icon: <img src={transaction} alt="" style={{ width: '20px', height: '20px' }}/>, label: <Link to="/transaction-page">Transaction Window</Link> },
  { key: '15', icon: <img src={offerSend} alt="" style={{ width: '20px', height: '20px' }}/> , label: <Link to="/offers">Offers</Link> },
