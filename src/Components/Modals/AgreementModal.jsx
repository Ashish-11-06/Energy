...
<br/>
  ...
  verticalAlign: 'top' // Align text to the top 
            ...
            <td style={{ border: '1px solid black', padding: '8px' }}>
              ...
              <div></div>  &nbsp;&nbsp;&nbsp;&nbsp;   (a)inform the {dynamicData.consumerName} and EXG Global of the indicative programme of works in respect of the Project, identifying the timing of the on-site works, energisation of the Injection Point and the anticipated Commercial Operations Date and shall update on any material changes to the programme;
              ...
              <div></div>  The {dynamicData.consumerName} shall:
  ...
  verticalAlign: 'top' // Align text to the top 
            ...
            <td style={{ border: '1px solid black', padding: '8px' }}>
              ...
              <p>
                The {dynamicData.consumerName} shall offtake its proportion of the energy generated by the Project in each Financial Year (Aggregate Contracted Electrical Output). In each month, the {dynamicData.consumerName} shall, unless instructed otherwise by the Generator, offtake its proportion of the energy generated by the Project in that month (Monthly Contracted Electrical Output).
              </p>
              <p>
                The Generator has the right to instruct and bill different Monthly Contracted Electrical Outputs for a {dynamicData.consumerName} in a month where:
              </p>
              <ul>
                <li>The {dynamicData.consumerName} have agreed with the Generator that different proportions apply between themselves for that month; and</li>
  ...
  verticalAlign: 'top' // Align text to the top 
          ...
          <tr>
           ...
           <td style={{border: '1px solid black',padding: '8px', textAlign: 'left', verticalAlign: 'top' }}>
            ...
            <td style={{ border: '1px solid black', padding: '8px' }}>
              <p>
                The Generator shall provide the {dynamicData.consumerName}(s) with monthly output forecasts, maintenance planning and forced outage data.   </p>
            </td>
          </tr>
...
<p ></p>
      ...
      <thead>
          ...
          <tr>
            ...
            <br />    <p><b>{dynamicData.generator}</b>  will subscribe to up to 74% of the equity share capital of the Generator, and the {dynamicData.consumerName}(s) will subscribe to at least 26%of the equity share capital of the Generator, in proportions to be more particularly set out in the Transaction Documents. 
           </p>
           ...
           <p><b>{dynamicData.generator}</b> will fund, or procure (in part or full) the debt component of the funding requirement by way of a secured term loan or such other debt instruments as it may solely determine.  To the extent hedging is required for any foreign exchange exposure then <b>{dynamicData.generator}</b> will procure such hedging. If {'<Generator>'} provides funding then it will be on arm’s length basis and as commercially agreed.</p>
            <p>The debt funding will be secured and the security will include, but not limited to, security on Project assets, receivables and any credit support as may be required from the {dynamicData.consumerName}(s).</p>
            </td>
          </tr>
  ...
  Obligation to fund cost overruns
            ...
            <p>other manner as may be reasonably required without the need for any
              <p> further capital infusion by the {dynamicData.consumerName}(s).</p></p>
              <br />
            </td>
          </tr>
          ...
          <tr>
            ...
            <p>Thereafter, in the first instance, <b>{dynamicData.generator}</b> (if required) and the {dynamicData.consumerName}(s) will fund the Generator (which funding amount will not be less than 50% of the equity commitment) through subscription of equity shares. </p>
...
const AgreementModal = ({ visible, onClose, data }) => {
 ...
 const tariff_finalized=data?.tariff_finalized;
